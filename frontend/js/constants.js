const contractAddress = "0x3cCe9cB65280f761358A7c9710EFAa1d30909beA"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Dogs World NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Dogs World NFT Project is a decentralized, open-source project. It launches my very first NFT Collection.';
